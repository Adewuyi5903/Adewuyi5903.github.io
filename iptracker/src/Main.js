...
useEffect(() => {
  try {
    const getInitialData = async () => {
      const res = await fetch (`https://geo.ipify.org/api/v2/country,city?apiKey=at_uucXm8TLEXdOHB0PRvxVni2MxRDJ8&ipAddress=8.8.8.8`)
...
async function getEnteredAddress (){
    const res = await fetch (`https://geo.ipify.org/api/v2/country,city?apiKey=at_uucXm8TLEXdOHB0PRvxVni2MxRDJ8&${ 
